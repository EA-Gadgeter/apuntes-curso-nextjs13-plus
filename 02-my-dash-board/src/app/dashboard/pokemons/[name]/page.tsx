...
import { getPokemonByName } from "@/services/pokemon/getPokemonByName";
...
export async function generateStaticParams() {
  const pokemonStaticNames = (await getAllPokemons(POKEMON_STATIC_PAGES)).map(pokemon => {
    return {
      name: pokemon.name
    };
  });
